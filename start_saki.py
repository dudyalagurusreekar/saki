...
def check_and_setup_venv():
    if not os.path.exists(VENV_DIR) or not os.path.exists(VENV_PYTHON):
        print("🛠️ Virtual environment 'venv' not found. Creating venv...")
        ...
        print("✅ Python virtual environment verified.")


def check_and_setup_frontend():
    if not os.path.exists(NODE_MODULES):
        print("🛠️ Frontend node_modules not found. Running npm install...")
